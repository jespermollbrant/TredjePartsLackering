  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-16">
      <article className="prose prose-neutral max-w-none">
        ...
        <p>
          <em>Vad det betyder i praktiken:</em> Om du skickar en vag förfrågan och resultatet inte blir som du tänkt dig, ligger ansvaret ofta på dig. Lackeraren har rätt att utgå från branschpraxis om inget annat specificerats.
        </p>
        ...
        <p>
          Har du ett projekt där du vill vara säker på att allt blir rätt från början? <a href="/kontakt" className="text-brand-blue hover:underline">Kontakta oss för en offertförfrågan</a>, så visar vi hur vi kan hjälpa dig.
        </p>
      </article>
    </main>
  );
