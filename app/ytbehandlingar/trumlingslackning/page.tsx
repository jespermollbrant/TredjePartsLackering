...
export default function TrumlingslackningPage() {
  return (
      ...
      <main>
        <section className="bg-gradient-brand py-20 md:py-32 relative overflow-hidden">
          ...
          <div className="container mx-auto px-6 text-center relative z-10">
            <nav className="text-sm text-white/80 mb-4">
              ...
              <span className="text-white">Trumlingslackning</span>
            </nav>
          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                Trumlingslackning är en ytbeläggande bearbetning där flera arbetsstycken kontinuerligt färgsprutas och 
                torkas i en roterande metalltrumma. Denna metod är särskilt effektiv för att behandla stora volymer av 
              ...
              <div className="space-y-6 mb-12">
                <div className="border-l-4 border-brand-green pl-6">
                  ...
                  <p className="text-slate-600">
                    Arbetsstyckena placeras i en roterande metalltrumma varpå det ytbehandlande medlet kontinuerligt 
                    sprejas mot arbetsstyckena i rörelse.
                  </p>
                </div>
                <div className="border-l-4 border-brand-orange pl-6">
                  <h3 className="text-xl font-semibold text-brand-orange mb-2">Torkning</h3>
                  <p className="text-slate-600">
                    En uppvärmd ström av luft tillförs till metalltrumman så att det ytbehandlande medlet kontinuerligt 
                    torkar på arbetsstyckenas ytor.
                  </p>
                </div>
                <div className="border-l-4 border-brand-blue pl-6">
                  <h3 className="text-xl font-semibold text-brand-blue mb-2">Kontinuerlig process</h3>
                  <p className="text-slate-600">
                    Processen fortsätter kontinuerligt medan detaljerna roterar i trumman, vilket säkerställer en 
                    jämn och konsekvent beläggning.
                  </p>
                </div>
                <div className="border-l-4 border-brand-yellow pl-6">
                  ...
                  <p className="text-slate-600">
                    Detaljerna bör ej vara stötkänsliga eller så stora/dynga att de skapar skador på varandra eller på belagd yta.
                  </p>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-12">
                <div className="card-brand p-6 border-l-4 border-green-500">
                  ...
                  <ul className="text-slate-600 space-y-2">
                    ...
                    <li>• Kontinuerlig process med hög effektivitet</li>
                    <li>• Jämn och konsekvent beläggning</li>
                    <li>• Lämplig för smådetaljer</li>
                ...
                <div className="card-brand p-6 border-l-4 border-red-500">
                  ...
                  <ul className="text-slate-600 space-y-2">
                    <li>• Begränsad till smådetaljer</li>
                    <li>• Risk för skador mellan detaljer</li>
                    <li>• Mindre kontroll över individuella detaljer</li>
                    <li>• Kräver att detaljer tål rörelse och kontakt</li>
                    <li>• Begränsad till enkla geometrier</li>
                  </ul>
                </div>
              </div>
              ...
              <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                Trumlingslackning är särskilt lämplig för små metallkomponenter som skruvar, muttrar, små delar och 
                andra mindre föremål som kan behandlas i bulk. Metoden fungerar bäst för detaljer som inte är stötkänsliga 
                och som kan tåla rörelse och kontakt med andra detaljer.
              </p>

              <h2 className="text-3xl font-bold mb-8 text-brand-indigo">Slutresultat</h2>
              <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                En kostnadseffektiv och konsekvent beläggning av stora volymer smådetaljer. Trumlingslackning ger en 
                jämn och effektiv ytbehandling som är idealisk för produktionslinjer där stora volymer av små komponenter 
                ska behandlas med hög effektivitet.
              </p>

              <div className="bg-slate-50 p-6 rounded-lg border border-slate-200">
                <h3 className="text-xl font-semibold text-brand-blue mb-4">Se hur trumlingslackning fungerar</h3>
                <p className="text-slate-600 mb-4">
                  Vill du se trumlingslackning i aktion? Klicka på länken nedan för att titta på en video som visar processen.
                </p>
                <a 
                  href="https://www.youtube.com/results?search_query=Trumlingslackning" 
                  target="_blank" 
                ...
                >
                  ...
                  Titta på video om trumlingslackning
                </a>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 bg-gradient-to-br from-slate-800 via-slate-900 to-slate-800 text-white relative overflow-hidden">
          ...
          <div className="container mx-auto px-6 relative z-10 text-center">
            <h2 className="text-3xl font-bold mb-4 text-white">Behöver du trumlingslackning för ditt projekt?</h2>
