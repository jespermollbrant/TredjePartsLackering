...
export default function SurzinkningPage() {
  return (
      ...
      <main>
        <section className="bg-gradient-brand py-20 md:py-32 relative overflow-hidden">
          ...
          <div className="container mx-auto px-6 text-center relative z-10">
            <nav className="text-sm text-white/80 mb-4">
              ...
              <span className="text-white">Surzinkning</span>
            </nav>
            <h1 className="text-4xl md:text-6xl font-bold leading-tight mb-4 text-white">
              Surzinkning
            </h1>
            <p className="text-lg md:text-xl text-white/90 max-w-3xl mx-auto">
              Snabb och effektiv förzinkning med en högblank, dekorativ finish
            </p>
          </div>
        </section>
          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                Surzinkning är en elförzinkningsprocess med sur kloridbaserad elektrolyt. Den ger hög effektivitet och ett mycket blankt, jämnt zinkskikt direkt från badet – idealiskt för storskalig produktion och komplexa detaljer.
              </p>
              ...
              <div className="space-y-6 mb-12">
                <div className="border-l-4 border-brand-green pl-6">
                  ...
                  <p className="text-slate-600">
                    Rigör rengöring med avfettning och betning för att säkerställa god vidhäftning och ren yta.
                  </p>
                </div>
                <div className="border-l-4 border-brand-orange pl-6">
                  <h3 className="text-xl font-semibold text-brand-orange mb-2">Elektroplätering i surt bad</h3>
                  <p className="text-slate-600">
                    Detaljen (katod) sänks i en sur kloridbaserad elektrolyt. Vid strömpåslag fälls zinkjoner ut snabbt till ett högblankt, slätt skikt med utmärkt täckförmåga även i lågströmsområden.
                  </p>
                </div>
                <div className="border-l-4 border-brand-yellow pl-6">
                  <h3 className="text-xl font-semibold text-brand-yellow mb-2">Passivering</h3>
                  <p className="text-slate-600">
                    Efter plätering passiveras ytan (ofta trevärt krom) som ger kraftigt förbättrad korrosionsbeständighet och skydd mot vitrost, med blå eller gul iriserande ton.
                  </p>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-12">
                <div className="card-brand p-6 border-l-4 border-green-500">
                  ...
                  <ul className="text-slate-600 space-y-2">
                    <li>• Mycket hög avsättningshastighet och effektivitet</li>
                    <li>• Naturligt högblank och dekorativ yta</li>
                    <li>• Utmärkt täckförmåga även i lågströmsområden</li>
                    <li>• Mindre risk för vätgasförsprödning än alkaliska bad</li>
                    <li>• Energieffektiv process</li>
                  </ul>
                </div>
                <div className="card-brand p-6 border-l-4 border-red-500">
                  <h3 className="text-xl font-semibold text-red-600 mb-3">Nackdelar</h3>
                  <ul className="text-slate-600 space-y-2">
                    <li>• Elektrolyten är mer korrosiv mot utrustning</li>
                    <li>• Högre krav på förbehandling; mindre förlåtande mot orenheter</li>
                  </ul>
                </div>
              </div>
              ...
              <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                Stål- och järnkomponenter där korrosionsskydd och högblank finish är viktiga, såsom butiksinredningar, konsumentprodukter, möbelbeslag, fästelement och fordonsdetaljer.
              </p>

              <h2 className="text-3xl font-bold mb-8 text-brand-indigo">Slutresultat</h2>
              <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                En skinande blank, slät zinkyta med effektivt korrosionsskydd – utmärkt för synliga komponenter som kräver perfekt finish.
              </p>

              <div className="bg-slate-50 p-6 rounded-lg border border-slate-200">
                <h3 className="text-xl font-semibold text-brand-blue mb-4">Se hur surzinkning fungerar</h3>
                <p className="text-slate-600 mb-4">
                  Vill du se surzinkning i aktion? Klicka på länken nedan för att titta på videor som visar processen.
                </p>
                <a 
                  href="https://www.youtube.com/results?search_query=Acid+zinc+plating+chloride" 
                  target="_blank" 
        ...
        <section className="py-20 bg-gradient-to-br from-slate-800 via-slate-900 to-slate-800 text-white relative overflow-hidden">
          ...
          <div className="container mx-auto px-6 relative z-10 text-center">
            <h2 className="text-3xl font-bold mb-4 text-white">Behöver du surzinkning för ditt projekt?</h2>
