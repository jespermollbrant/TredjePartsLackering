          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-slate-50 p-6 rounded-lg border border-slate-200">
                <h3 className="text-xl font-semibold text-brand-blue mb-4">Se hur gardinlackering fungerar</h3>
                <p className="text-slate-600 mb-4">
                  Vill du se gardinlackering i aktion? Klicka på länken nedan för att titta på en video som visar processen.
                </p>
                <a 
                  href="https://www.youtube.com/results?search_query=Gardinlackering" 
                  target="_blank" 
                ...
                >
                  ...
                  Titta på video om gardinlackering
                </a>
              </div>
            </div>
          </div>
