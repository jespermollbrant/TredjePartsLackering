...
export default function MultilagerFornicklingPage() {
  return (
      ...
      <main>
        <section className="bg-gradient-brand py-20 md:py-32 relative overflow-hidden">
          ...
          <div className="container mx-auto px-6 text-center relative z-10">
            <nav className="text-sm text-white/80 mb-4">
              ...
              <span className="text-white">Multilagerförnickling</span>
            </nav>
            <h1 className="text-4xl md:text-6xl font-bold leading-tight mb-4 text-white">
              Multilagerförnickling
            </h1>
            <p className="text-lg md:text-xl text-white/90 max-w-3xl mx-auto">
              Maximerar korrosionsskyddet genom en smart, skiktad uppbyggnad
            </p>
          </div>
        </section>
          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                Multilagerförnickling skapar ett överlägset korrosionsskydd genom att applicera två eller flera nickelager med olika egenskaper. Genom potentialskillnader fungerar yttre lager som offeranod och bromsar korrosion i sidled innan den når underliggande lager och grundmaterial.
              </p>
              ...
              <div className="space-y-6 mb-12">
                <div className="border-l-4 border-brand-green pl-6">
                  ...
                  <p className="text-slate-600">
                    Grundlig rengöring och ytaktivering säkerställer optimal vidhäftning för följande nickellager.
                  </p>
                </div>
                <div className="border-l-4 border-brand-orange pl-6">
                  <h3 className="text-xl font-semibold text-brand-orange mb-2">Lager 1 – Halvblankt nickel</h3>
                  <p className="text-slate-600">
                    Ett relativt tjockt, segt och svavelfritt lager som utgör basen för skyddet.
                  </p>
                </div>
                <div className="border-l-4 border-brand-blue pl-6">
                  <h3 className="text-xl font-semibold text-brand-blue mb-2">Lager 2 – Glansnickel</h3>
                  <p className="text-slate-600">
                    Ett tunnare, svavelinnehållande lager som är mindre ädelt än underlaget och skapar offeranod‑effekten.
                  </p>
                </div>
                <div className="border-l-4 border-brand-yellow pl-6">
                  <h3 className="text-xl font-semibold text-brand-yellow mb-2">Eventuellt tredje lager</h3>
                  <p className="text-slate-600">
                    Ett mycket tunt höghaltigt svavellager kan läggas in mellan huvudlagren. Ofta avslutas med ett tunt kromlager för estetik och slitstyrka.
                  </p>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-12">
                <div className="card-brand p-6 border-l-4 border-green-500">
                  ...
                  <ul className="text-slate-600 space-y-2">
                    <li>• Exceptionellt högt korrosionsskydd</li>
                    <li>• Betydligt längre livslängd</li>
                    <li>• Blank, dekorativ yta</li>
                    <li>• Utmärkt underlag för krom</li>
                    <li>• Robust metod för tuffa miljöer</li>
                  </ul>
                </div>
                <div className="card-brand p-6 border-l-4 border-red-500">
                  ...
                  <ul className="text-slate-600 space-y-2">
                    ...
                    <li>• Kräver kontroll av flera bad</li>
                    <li>• Högre processkostnad</li>
                  </ul>
                </div>
              </div>
              ...
              <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                Idealiskt för stål, zink, koppar och aluminium i hårda miljöer. Vanligt inom fordonsindustrin (exteriöra detaljer), marina applikationer och utomhusarmaturer.
              </p>

              <h2 className="text-3xl font-bold mb-8 text-brand-indigo">Slutresultat</h2>
              <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                Ett intelligent, mycket robust ytskydd med finish av högsta kvalitet och långsiktigt korrosionsskydd som överträffar enskiktslösningar.
              </p>

              <div className="bg-slate-50 p-6 rounded-lg border border-slate-200">
                <h3 className="text-xl font-semibold text-brand-blue mb-4">Se multilagerförnickling i praktik</h3>
                <p className="text-slate-600 mb-4">
                  Vill du fördjupa dig? Klicka på länken nedan för att se videor om multilagerförnickling.
                </p>
                <a 
                  href="https://www.youtube.com/results?search_query=Duplex+nickel+plating+layer" 
                  target="_blank" 
                ...
                >
                  ...
                  Titta på video om multilagerförnickling
                </a>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 bg-gradient-to-br from-slate-800 via-slate-900 to-slate-800 text-white relative overflow-hidden">
          ...
          <div className="container mx-auto px-6 relative z-10 text-center">
            <h2 className="text-3xl font-bold mb-4 text-white">Behöver du multilagerförnickling?</h2>
