...
export default function PyrolysrensningPage() {
  return (
      ...
      <main>
        <section className="bg-gradient-brand py-20 md:py-32 relative overflow-hidden">
          ...
          <div className="container mx-auto px-6 text-center relative z-10">
            <nav className="text-sm text-white/80 mb-4">
              ...
              <span className="text-white">Pyrolysrensning</span>
            </nav>
          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                Pyrolysrensning är en rengöring av arbetsstycke under hög värme och frånvaro av syre vilket resulterar i pyrolys. 
                Denna process förvandlar gamla färgskikt och beläggningar till aska genom termisk nedbrytning utan förbränning.
              </p>
              ...
              <div className="space-y-6 mb-12">
                <div className="border-l-4 border-brand-green pl-6">
                  <h3 className="text-xl font-semibold text-brand-green mb-2">Uppvärmning</h3>
                  <p className="text-slate-600">
                    Arbetsstycket värms upp till omkring 400°C i en syrefri miljö och hålls i upp till 12 timmar.
                  </p>
                </div>
                <div className="border-l-4 border-brand-orange pl-6">
                  <h3 className="text-xl font-semibold text-brand-orange mb-2">Pyrolys</h3>
                  <p className="text-slate-600">
                    Detta gör att orenheter på dess yta övergår till aska och ångor utan att någon förbränning sker, så pyrolys.
                  </p>
                </div>
                <div className="border-l-4 border-brand-blue pl-6">
                  <h3 className="text-xl font-semibold text-brand-blue mb-2">Avlägsning</h3>
                  <p className="text-slate-600">
                    Efter processen kan askan enkelt avlägsnas från ytan, vilket lämnar en ren grund för vidare behandling.
                  </p>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-12">
                <div className="card-brand p-6 border-l-4 border-green-500">
                  ...
                  <ul className="text-slate-600 space-y-2">
                    <li>• Ingen rengöring med kemikalier behövs</li>
                    <li>• Ingen mekanisk rengöring behövs</li>
                    <li>• Mycket effektiv för gamla färgskikt</li>
                    <li>• Miljövänlig process</li>
                    <li>• Lämplig för komplexa geometrier</li>
                  </ul>
                </div>
                <div className="card-brand p-6 border-l-4 border-red-500">
                  <h3 className="text-xl font-semibold text-red-600 mb-3">Nackdelar</h3>
                  <ul className="text-slate-600 space-y-2">
                    <li>• Arbetsstycket utsätts för hög värme vilket kan påverka materialets egenskaper</li>
                    <li>• Långsam process (upp till 12 timmar)</li>
                    <li>• Kräver specialiserad ugn</li>
                    <li>• Begränsad till värmetåliga material</li>
                  </ul>
                </div>
              </div>
              ...
              <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                Pyrolysrensning är lämplig för metaller som tål höga temperaturer, särskilt stål och gjutjärn. 
                Metoden är särskilt effektiv för att rengöra komponenter med gamla färgskikt eller beläggningar 
                som är svåra att avlägsna med andra metoder.
              </p>

              <h2 className="text-3xl font-bold mb-8 text-brand-indigo">Slutresultat</h2>
              <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                En ren yta där gamla färgskikt och beläggningar har förvandlats till aska som enkelt kan avlägsnas. 
                Pyrolysrensning ger en mycket grundlig rengöring som är idealisk för renovering och återanvändning 
                av komponenter.
              </p>

              <div className="bg-slate-50 p-6 rounded-lg border border-slate-200">
                <h3 className="text-xl font-semibold text-brand-blue mb-4">Se hur pyrolysrensning fungerar</h3>
                <p className="text-slate-600 mb-4">
                  Vill du se pyrolysrensning i aktion? Klicka på länken nedan för att titta på en video som visar processen.
                </p>
                <a 
                  href="https://www.youtube.com/results?search_query=Pyrolysrensning" 
                  target="_blank" 
                ...
                >
                  ...
                  Titta på video om pyrolysrensning
                </a>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 bg-gradient-to-br from-slate-800 via-slate-900 to-slate-800 text-white relative overflow-hidden">
          ...
          <div className="container mx-auto px-6 relative z-10 text-center">
            <h2 className="text-3xl font-bold mb-4 text-white">Behöver du pyrolysrensning för ditt projekt?</h2>
