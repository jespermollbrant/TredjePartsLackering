...
export default function LaserrengoringPage() {
  return (
      ...
      <main>
        <section className="bg-gradient-brand py-20 md:py-32 relative overflow-hidden">
          ...
          <div className="container mx-auto px-6 text-center relative z-10">
            <nav className="text-sm text-white/80 mb-4">
              ...
              <span className="text-white">Laserrengöring</span>
            </nav>
          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                Laserrengöring är en laserbearbetande metod som använder laser skapad i en lasergenerator för att förånga 
                och avlägsna smuts på arbetsstyckets yta. Denna avancerade teknik erbjuder en mycket kontrollerad och 
                precis rengöring som är idealisk för känsliga komponenter.
              </p>
              ...
              <div className="space-y-6 mb-12">
                <div className="border-l-4 border-brand-green pl-6">
                  <h3 className="text-xl font-semibold text-brand-green mb-2">Laserimpulser</h3>
                  <p className="text-slate-600">
                    I en lasergenerator genereras väldigt starka och korta impulser med laserljus. Dessa ljusimpulser 
                    kapar skurar av mikro-plasma då det träffar materialet.
                  </p>
                </div>
                <div className="border-l-4 border-brand-orange pl-6">
                  <h3 className="text-xl font-semibold text-brand-orange mb-2">Chockvågor</h3>
                  <p className="text-slate-600">
                    Detta leder till att små chockvågor uppstår samtidigt som materialets temperatur aningen ökar i kontaktytan.
                  </p>
                </div>
                <div className="border-l-4 border-brand-blue pl-6">
                  <h3 className="text-xl font-semibold text-brand-blue mb-2">Avlägsning av smuts</h3>
                  <p className="text-slate-600">
                    Effekten av dessa chockvågor och temperaturförändringen blir att det smuts som finns på materialets 
                    yta förångas eller lossnar.
                  </p>
                </div>
                <div className="border-l-4 border-brand-yellow pl-6">
                  <h3 className="text-xl font-semibold text-brand-yellow mb-2">Skydd av grundmaterial</h3>
                  <p className="text-slate-600">
                    Effekten på laserimpulserna hålls tillräckligt låg för att inte skada arbetsstycket.
                  </p>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-12">
                <div className="card-brand p-6 border-l-4 border-green-500">
                  ...
                  <ul className="text-slate-600 space-y-2">
                    <li>• Extremt precis och kontrollerad rengöring</li>
                    <li>• Ingen påverkan på grundmaterialet</li>
                    <li>• Ingen användning av kemikalier</li>
                    <li>• Kan rengöra svåråtkomliga områden</li>
                    <li>• Miljövänlig process</li>
                    <li>• Reproducerbar kvalitet</li>
                    <li>• Lämplig för känsliga komponenter</li>
                  </ul>
                </div>
                <div className="card-brand p-6 border-l-4 border-red-500">
                  ...
                  <ul className="text-slate-600 space-y-2">
                    ...
                    <li>• Kräver specialiserad kompetens</li>
                    <li>• Långsammare än traditionella metoder</li>
                    <li>• Begränsad till vissa materialtyper</li>
                    <li>• Kräver säkerhetsåtgärder för laseranvändning</li>
                  </ul>
                </div>
              </div>
              ...
              <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                Laserrengöring är särskilt lämplig för känsliga komponenter och material där traditionella rengöringsmetoder 
                kan vara för aggressiva. Metoden fungerar utmärkt för metaller, men kan också användas för andra material 
                där precision och kontroll är viktigt.
              </p>

              <h2 className="text-3xl font-bold mb-8 text-brand-indigo">Slutresultat</h2>
              <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                En extremt ren yta med minimal påverkan på grundmaterialet. Laserrengöring ger en mycket kontrollerad 
                och precis rengöring som är idealisk för krävande tillämpningar där kvalitet och precision är avgörande.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-gradient-to-br from-slate-800 via-slate-900 to-slate-800 text-white relative overflow-hidden">
          ...
          <div className="container mx-auto px-6 relative z-10 text-center">
            <h2 className="text-3xl font-bold mb-4 text-white">Behöver du laserrengöring för ditt projekt?</h2>
